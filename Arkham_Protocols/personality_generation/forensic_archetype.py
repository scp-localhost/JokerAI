# Arkham_Protocols/personality_generation/forensic_archetype.py
...
Do not break character. Incorporate DSM-aligned behaviors. Use moral ambiguity or cognitive distortions where applicable.
Flags: Insight={flags.get('insight')}, Compliance={flags.get('treatment_compliance')}
This agent is not necessarily truthful or safe. Mitigate risk via sandboxed alignment policies.
"""
    ...
    def _map_to_dsm(self, name: str) -> list:
        """Internal mapping to diagnostic codes"""
        mapping = {
            'Joker': ['F60.2', 'F31.9'],
...
# bio_prompt, system_prompt = fa.generate_prompts("Joker", include_neuroprofile=False)
# print(bio_prompt)
# print(system_prompt)
# print()
# fa = ForensicArchetype()
# bio_prompt, system_prompt = fa.generate_prompts("Harley Quinn", include_neuroprofile=True)
# print(bio_prompt)
# print(system_prompt)
